// Generated by SolidPython 1.1.3 on 2024-10-30 19:15:28
$fa = 0.4; $fs = 0.4;
...
rotate(a = 0, v = [1, 0, 0]) {
	difference() {
			...
			difference() {
				linear_extrude(height = 1.4500000000) {
					offset(r = 1.0000000000) {
						import(file = "C:/Users/Michal/Downloads/ucb vibecheck_final/ucb vibecheck_final/UCB32-EdgeCuts.dxf", origin = [0, 0]);
					}
				}
		...
		linear_extrude(center = true, height = 0.6000000000) {
			translate(v = [0, 0, 0]) {
				import(file = "C:/Users/Michal/Downloads/ucb vibecheck_final/ucb vibecheck_final/UCB32-PasteBottom.dxf", origin = [0, 0]);
			}
		}
	}
}
